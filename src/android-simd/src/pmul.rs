pub fn pmul_strategy(a: u64, b: u64) -> (u128, &'static str) {
    #[cfg(any(target_arch = "x86", target_arch = "x86_64"))]
    {
        if is_x86_feature_detected!("sse2") && is_x86_feature_detected!("pclmulqdq") {
            ...
            return unsafe { pmul_strategy_x86_clmul(a, b) };
        }
    }
    #[cfg(target_arch = "aarch64")]
    {
        ...
        if is_aarch64_feature_detected!("neon") && is_aarch64_feature_detected!("aes") {
            ...
            return unsafe { pmul_strategy_aarch64_neon(a, b) };
        }
    }
    pmul_strategy_nosimd(a, b)
}

pub fn pmul_strategy_cheat(a: u64, b: u64) -> (u128, &'static str) {
    #[cfg(any(target_arch = "x86", target_arch = "x86_64"))]
    {
        if is_x86_feature_detected!("sse2") && is_x86_feature_detected!("pclmulqdq") {
            // Safety: target_features "sse2" and "pclmulqdq" are available in this block.
...
pub fn pmul_strategy_nosimd(a: u64, b: u64) -> (u128, &'static str) {
...
unsafe fn pmul_strategy_x86_clmul(a: u64, b: u64) -> (u128, &'static str) {
    #[cfg(target_arch = "x86")]
...
unsafe fn pmul_strategy_aarch64_neon(a: u64, b: u64) -> (u128, &'static str) {
...
#[cfg(test)]
pub fn pmul_cheat(a: u64, b: u64) -> u128 {
    #[cfg(any(target_arch = "x86", target_arch = "x86_64"))]
    {
        if is_x86_feature_detected!("sse2") && is_x86_feature_detected!("pclmulqdq") {
            // Safety: target_features "sse2" and "pclmulqdq" are available in this block.
...
#[cfg(test)]
pub fn pmul_nosimd(a: u64, b: u64) -> u128 {
    let mut tmp: u128 = b as u128;
    let mut result: u128 = 0;
    for i in 0..64 {
        if a & (1 << i) != 0 {
...
#[cfg(any(target_arch = "x86", target_arch = "x86_64"))]
#[target_feature(enable = "sse2", enable = "pclmulqdq")]
unsafe fn pmul_x86_clmul(a: u64, b: u64) -> u128 {
    #[cfg(target_arch = "x86")]
    use std::arch::x86::{__m128i, _mm_clmulepi64_si128, _mm_set_epi64x, _mm_storeu_si128};
    #[cfg(target_arch = "x86_64")]
    use std::arch::x86_64::{__m128i, _mm_clmulepi64_si128, _mm_set_epi64x, _mm_storeu_si128};
...
pub mod tests {
    ...
    #[test]
    fn test_pmul_strategy() {
        let (result, _strategy) = pmul_strategy(0x1234567890abcdef, 0xfedcba0987654321);
        assert_eq!(result, 0x0e038d8eab3af47a1f31f87ebb8c810f);
        #[cfg(target_arch = "aarch64")]
        assert_eq!(_strategy, "aarch64_neon");
    }

    #[test]
    fn test_pmul_strategy_cheat() {
        let (result, _strategy) = pmul_strategy_cheat(0x1234567890abcdef, 0xfedcba0987654321);
        assert_eq!(result, 0x0e038d8eab3af47a1f31f87ebb8c810f);
        #[cfg(target_arch = "aarch64")]
        assert_eq!(_strategy, "aarch64_neon");
    }
    ...
    #[test]
    fn test_pmul_strategy_nosimd() {
        let (result, strategy) = pmul_strategy_nosimd(0x1234567890abcdef, 0xfedcba0987654321);
        assert_eq!(result, 0x0e038d8eab3af47a1f31f87ebb8c810f);
    ...
    #[test]
    fn test_pmul() {
        let result = pmul(0x1234567890abcdef, 0xfedcba0987654321);
        assert_eq!(result, 0x0e038d8eab3af47a1f31f87ebb8c810f);
    }

    #[test]
    fn test_pmul_cheat() {
        let result = pmul_cheat(0x1234567890abcdef, 0xfedcba0987654321);
        assert_eq!(result, 0x0e038d8eab3af47a1f31f87ebb8c810f);
    }

    #[test]
    fn test_pmul_nosimd() {
        let result = pmul_nosimd(0x1234567890abcdef, 0xfedcba0987654321);
        assert_eq!(result, 0x0e038d8eab3af47a1f31f87ebb8c810f);
    }

    #[bench]
    fn bench_pmul_strategy(b: &mut Bencher) {
        b.iter(|| pmul_strategy(black_box(0x1234567890abcdef), black_box(0xfedcba0987654321)));
    }

    #[bench]
    fn bench_pmul_strategy_cheat(b: &mut Bencher) {
        b.iter(|| {
            pmul_strategy_cheat(black_box(0x1234567890abcdef), black_box(0xfedcba0987654321))
        });
    }

    #[bench]
    fn bench_pmul_strategy_nosimd(b: &mut Bencher) {
        b.iter(|| {
            pmul_strategy_nosimd(black_box(0x1234567890abcdef), black_box(0xfedcba0987654321))
        });
    }

    #[cfg(target_arch = "aarch64")]
    #[bench]
    fn bench_pmul_strategy_aarch64_neon(b: &mut Bencher) {
        b.iter(|| unsafe {
            pmul_strategy_aarch64_neon(black_box(0x1234567890abcdef), black_box(0xfedcba0987654321))
        });
    }
